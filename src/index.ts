...
server.tool(
  "create_issue",
  "Create a new issue in a GitHub repository（GitHub リポジトリで新しい Issue を作成する）",
  {
    owner: z.string(),
    repo: z.string(),
    title: z.string(),
...
server.tool(
  "list_open_issues",
  "List open issues in a GitHub repository（未クローズの Issue を一覧表示する）",
  {
    owner: z.string(),
    repo: z.string(),
...
server.tool(
  "add_issue_comment",
  "Add a comment to a GitHub issue（Issue にコメントを追加する）",
  {
    owner: z.string(),
    repo: z.string(),
...
server.tool(
  "get_issue_comments",
  "Get comments from a GitHub issue（Issue のコメントを取得する）",
  {
    owner: z.string(),
    repo: z.string(),
    issue_number: z.number(),
...
server.tool(
  "close_issue",
  "Close a GitHub issue（Issue をクローズする）",
  {
    owner: z.string(),
    repo: z.string(),
    issue_number: z.number(),
...
server.tool(
  "update_issue",
  "Update an existing GitHub issue（Issue を更新する）",
  {
    owner: z.string(),
    repo: z.string(),
    issue_number: z.number(),
...
server.tool(
  "get_issue",
  "Get details of a GitHub issue（Issue の詳細を取得する）",
  {
    owner: z.string(),
    repo: z.string(),
    issue_number: z.number(),
...
server.tool(
  "search_issues",
  "Search issues in a repository（リポジトリ内の Issue を検索する）",
  {
    owner: z.string(),
    repo: z.string(),
